...
movies_credits = pd.read_parquet(r'C:\Users\Elias\Documents\Tercer proyecto individual\Datasets_limpios\movies_credits.parquet') #Se crea un DataFrame para las diferentes consultas.
recomendacion_df = pd.read_parquet(r'C:\Users\Elias\Documents\Tercer proyecto individual\Datasets_limpios\recomendación.parquet')
